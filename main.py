...
async def wait_message_streaming_detached(locator):
...
async def send_message_async(message):
    async with async_playwright() as p:
        ...
        await wait_message_streaming_detached(page.locator("main .group"))
        i = await page.locator("main .group").count()
        print(await page.locator("main .group").filter(has_not_text="?").last.inner_text())
